...
function Sidebar() {
  return (
    <div className="flex flex-col px-6 pt-9 pb-5 mx-auto mt-4 w-full text-lg text-white whitespace-nowrap bg-cyan-800 shadow-sm rounded-[35.556px] max-md:px-5 max-md:mt-10">
